...
const configItems = [
    ...
    { key: "border-radius", alias: "radius br", handler: "pmwh" },
    ...
    { key: "background-color", alias: "bg fill", handler: "color" },
    { key: "border-color", alias: "bc", handler: "color" },
    { key: "outline-color", alias: "oc", handler: "color" },
    { key: "color", alias: "fci c", handler: "color" },
    ...
    { key: "font-weight", alias: "fw weight", handler: "identity" },
    { key: "font-family", alias: "ff font", handler: "fontFamily" },
...
function fix(value) {
    ...
    let direction = 0
    const directions = ["top", "right", "left", "bottom", "x", "y"]
    let position = 0
...
function converter(...args) {
    ...
    const converterO = (o) => {
        return Object.entries(o).map(([k,v]) => converterAB(k, v)).flat()
    }
    ...
    const converterS = (s) => {
        ...
        const matches = items.map((item) => {
            const [a, b] = item[2] == null ? [item[1], true] : [item[1], item[2]]
